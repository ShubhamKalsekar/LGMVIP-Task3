...
function insertNewRecord(data) {
  ...
  // cell5.innerHTML = data.ContactNumber;
  cell5 = newRow.insertCell(4);
...
function onEdit(td) {
  ...
  // document.getElementById("ContactNumber").value = selectedRow.cells[4].innerHTML;
...
function updateRecord(formData) {
  ...
  // selectedRow.cells[4].innerHTML = formData.ContactNumber;
